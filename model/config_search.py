...
C.layers = 5 # layers (cells) for supernet
...
#C.prun_modes = ['max',]
# channel pruning mode for [teacher, student], i.e. by default teacher will use max channel number, and student will sample the channel number based on arch_ratio
